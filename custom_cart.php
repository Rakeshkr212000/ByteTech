...
<section class="cart_area">
    <div class="container">
        <div class="cart_inner">
            ...
            $re = mysqli_query($db, "SELECT * FROM custom_cart where u_name='$u_name' and conf_c=0 ");
                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                <td><a href="delete_c.php?action=delete&id=<?php echo $row["id"]  ?>"><span class="text-danger">Remove Item</span></a></td>
                        ...
                        <tr class="out_button_area">
                            ...
                            <td>
                                <div class="checkout_btn_inner d-flex align-items-center">
                                    ...
                                    <a class="primary-btn" href="c_checkout.php">Proceed to checkout</a>
                                </div>
                            </td>
                        </tr>
                        </tr>
