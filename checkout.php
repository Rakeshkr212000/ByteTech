                    ...
                    <div class=" col-lg-4">
                                <div class="order_box">
                                    ...
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        <a class="primary-btn" href="update_cart.php?action=<?php echo $_SESSION["username"]  ?> ">Proceed to checkout</a>
                                    </div> -->
                                    ...
                                    <a class="primary-btn" href="card.php?action=<?php echo $_SESSION["username"]  ?>">Proceed to card payment</a>
                                </div>
                            </div>
                </div>
            </div>
