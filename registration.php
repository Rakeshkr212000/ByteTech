				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" method="post" id="contactForm" >
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" name="f_name" required  placeholder="fullname" onfocus="this.placeholder = ''" onblur="this.placeholder = 'fullname'">
								<small>*Enter your full name</small>
							</div>
                            <div class="col-md-12 form-group">
								<input type="email" class="form-control" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  name="email" placeholder="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'email'">
								<small>*Format: eg:wakawaka@hotmail.com</small>
							</div>
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" required name="address"  placeholder="address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'address'">
							...
							<div class="col-md-12 form-group">
								<input type="tel" class="form-control" required name="phone_no" pattern="[0-9]{10}"  placeholder="enter your phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'" required>
							<small>*Format: eg:900000
								0009</small>
							</div>

							<div class="col-md-12 form-group">
								<input type="password" class="form-control" required name="password" pattern=".{5,}" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'" title="Must contain at least 8 or more characters">
